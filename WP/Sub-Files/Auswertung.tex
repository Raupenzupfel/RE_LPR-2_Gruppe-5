...
Mit $\dot Q_{Verd}=5,84kW$, $h_1=448\frac{kJ}{kg}$ und $h_4=280\frac{kJ}{kg}$ wird der Massenstrom des Kondensators nach \autoref*{eq230623_massestrom_ver} berechnet:
...
\label{230623_Verdichterleistung}
\end{equation}
$$  P_{mech} = 0,04436 \cdot (448-425)\frac{kJ}{kg} = 0,4548 \approx 45,48 \% $$
