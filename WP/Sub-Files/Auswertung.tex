...
\begin{table}[!h]
    ...
    2                                  & Heißgastemperatur            & 66                                   & 448                                     \\ \hline
    3                                  & Temperatur nach Verflüssiger & 43                                    & 280                                     \\ \hline
    4                                  & Temperatur vor Verdampfer    & 15                                    & 280                                     \\ \hline
    \end{tabular}%
    }
...
$$\eta_{is}=\frac{433 \frac{kJ}{kg}-425 \frac{kJ}{kg}}{448 \frac{kJ}{kg}-425 \frac{kJ}{kg}}=0,6521$$
...
\begin{equation}
  \dot m_{AM} = \frac{\dot Q_{Verd}}{|(h_1-h_4)|}
    \label{eq:230623_massestrom_ver}
\end{equation}

Mit $\dot Q_{Verd}=5,84kW$, $h_1=425\frac{kJ}{kg}$ und $h_4=223\frac{kJ}{kg}$ wird der Massenstrom des Kondensators nach \autoref*{eq:230623_massestrom_ver} berechnet:
...
$$\eta_{Ver} = \frac{0,04436 \frac{kg}{s}\cdot (448-425)\frac{kJ}{kg}}{P_{el}\cdot \eta_{is}}= 0,4548 \approx 45,48 \% $$
